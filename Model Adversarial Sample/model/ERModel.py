...
class TPLinkerBiLSTM(nn.Module):
    def __init__(self, init_word_embedding_matrix,
        ...
        # self.ent_fc = nn.Linear(2*hidden_size, 2)
        # self.head_rel_fc_list = [nn.Linear(2*hidden_size, 3) for _ in range(rel_size)]
        # self.tail_rel_fc_list = [nn.Linear(2*hidden_size, 3) for _ in range(rel_size)]
