...
common = {
    "exp_name": "dataset",  # dataset14 data-dvp-0112
    "rel2id": "rel2id.json",
    "device_num": 0,
    "encoder": "BiLSTM",
    # "encoder": "BERT",
...
eval_config = {
    ...
    "model_state_dict_dir":"dataset/saved_dict/model_state_dict_5.pt",
    # if use wandb, set "./wandb", or set "./default_log_dir" if you use default logger
    # vds hSQXUKfg dvp0112 gqzNrVED pd 7n6CTKQf vp qoCVFZBS sFgbWkSz 14m kloY5WXn
    "run_ids": ["sFgbWkSz", ],
    # DsJTK1fm dvp CWPKumXw, vd wGnfKtTX,vp cs04t6Yj, pd hBrzYKPO, dvp1 5LN4nzvH, dataset14 pauVbnFJ 20, sFgbWkSz 5 qu oyCU3v4L
    "last_k_model": 1,
    "test_data": "test_data_unk1.json",  # "*test*.json" vd vp
...
bilstm_config = {
    ...
    "pretrained_word_embedding_path": "../pretrained_word_emb/glove_{}_{}.emb".format(100, "dataset14"),
    # common["exp_name"]
    "hyper_parameters": {
        "lr": 1e-4,
        "enc_hidden_size": 400,
