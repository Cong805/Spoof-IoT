...
def region_repalce(word_index, model, texts, embeddings,vocab,word, content, alternative_words):
    ...
    def invisible_meta_replace(soup, meta, meta_words):
        if word in meta_words:
            ...
            twords = replace.repeat_insert(embeddings, vocab, word, alternative_words)
    ...
    def similar_replace(soup,head, text):
        if word in text:
            ...
            tword = replace.repeat_insert(embeddings, vocab, word, alternative_words)
    ...
    if soup.find_all("body"):
        ...
        hotword = replace.repeat_insert(embeddings, vocab, word, alternative_words)
